...
// Your code here...
console.log(string1.indexOf("j")); // Output: 21
...
const start = fruit.indexOf(favorite);
const end = start + favorite.length;

const favoriteFruit = fruit.slice(start, end);
...
if (includesOxygen1) {
  console.log("Headline 1 includes the word 'oxygen'");
} else {
  console.log("Headline 1 does not include the word 'oxygen'");
}

// Check the second headline
const includesOxygen2 = funnyHeadline2.includes("oxygen");

if (includesOxygen2) {
  console.log("Headline 2 includes the word 'oxygen'");
} else {
  console.log("Headline 2 does not include the word 'oxygen'");
}
